...
def exe(files_name,num_to_save,data_name,CD_model,model_name,has_two_learners,has_communities,is_community_level,
    ...
    to_save_data = all_params["to_save_data"]
    ...
    for cand_param in all_combinations:
        ...
        if to_save_data:
            save_to_gzip(train_dict,'train_{}_{}_{}_{}_{}.gz'.format(params_str,data_name,int(has_communities),seed,files_name[0]))
            save_to_gzip(test_dict,'test_{}_{}_{}_{}_{}.gz'.format(params_str,data_name,int(has_communities),seed,files_name[0]))
            continue
...
def exe_community(files_name,data_name,CD_model,model_name,has_two_learners,has_communities,is_community_level,seed,
    ...
    if only_validate:
        ...
        #find best parameters for each community or iters = 1 - find best parameters for all communities
        ######## NOTE #########
        ...
        for i in range(iters):
            ...
            for combination in all_combinations:
                ...
                for rho in rhos:
                    ...
                    if to_save_data:
                        params_str = ','.join(map(str, n2v_params))
                        save_to_gzip(train_dict,'train_{}_{}_{}_{}_{}.gz'.format(params_str,data_name,int(has_communities),seed,files_name[0]))
                        save_to_gzip(test_dict,'test_{}_{}_{}_{}_{}.gz'.format(params_str,data_name,int(has_communities),seed,files_name[0]))
...
if __name__ == '__main__':
    ...
    model_params_path = "MLP_params.json"
    model_params = convert_file2obj(model_params_path)
